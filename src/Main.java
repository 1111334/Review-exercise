...
public class Main {
    public static void main(String[] args) {
        ...
        Student bestStudent = null; // Inizializziamo lo studente eccellente come null
        double highestAverage = -1.0; // Inizializziamo la media più alta a un valore negativo
